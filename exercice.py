...
def implement_llama_3_3_model():
    ...
    """
    llm = ChatGroq("llama-3.3-70b-versatile", temperature=0.3)
    return llm
...
def implement_query_model(model, prompt):
    ...
    """
    # Le mock ChatGroq attend une liste de messages directement
...
def implement_compare_models(prompt):
    ...
    """
    results = {}
    results["llama_4_model"] = implement_query_model(implement_llama_4_model(), prompt)
    results["llama_3_3_model"] = implement_query_model(implement_llama_3_3_model(), prompt)
    return results
